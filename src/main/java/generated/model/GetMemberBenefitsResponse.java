...
public class GetMemberBenefitsResponse   {
   ...
   **/
  public GetMemberBenefitsResponse itemCodes(List<String> itemCodes) {
   ...
   **/
  public GetMemberBenefitsResponse dealCodes(List<String> dealCodes) {
   ...
   **/
  public GetMemberBenefitsResponse discounts(List<Discount> discounts) {
  ...
  public boolean equals(Object o) {
    ...
    GetMemberBenefitsResponse getMemberBenefitsResponse = (GetMemberBenefitsResponse) o;
    return Objects.equals(itemCodes, getMemberBenefitsResponse.itemCodes) &&
        Objects.equals(dealCodes, getMemberBenefitsResponse.dealCodes) &&
        Objects.equals(discounts, getMemberBenefitsResponse.discounts);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetMemberBenefitsResponse {\n");
